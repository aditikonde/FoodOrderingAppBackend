...
//    //This test case passes when you have handled the exception of trying to signup with invalid email-id.
    ...
    public void shouldNotSignUpForInvalidEmailId() throws Exception {
        when(mockCustomerService.signup(any()))
...
//        when(mockCustomerService.updateCustomer("auth",customerEntity)).thenReturn(updatedCustomerEntity);
//        mockMvc
...
//        verify(mockCustomerService, times(1)).updateCustomer("auth", customerEntity);
//    }
//
