...
public class PaymentControllerTest {
    ...
    @MockBean
    private PaymentBusinessService mockPaymentService;
    ...
    public void shouldGetAllPaymentMethods() throws Exception {
        ...
        paymentEntity.setPayment_name("samplePaymentName");

        when(mockPaymentService.getAllMethods())
        ...
        verify(mockPaymentService, times(1)).getAllMethods();
    }
