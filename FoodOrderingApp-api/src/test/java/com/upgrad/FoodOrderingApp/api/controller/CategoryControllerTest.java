...
public class CategoryControllerTest {
    ...
    public void shouldGetCategoryById() throws Exception {
        ...
        when(mockCategoryService.getCategory("sampleCategoryId")).thenReturn(categoryEntity);
        ...
        verify(mockCategoryService, times(1)).getCategory("sampleCategoryId");
    }
    ...
    public void shouldNotGetCategoryByidIfCategoryIdIsEmpty() throws Exception {
        when(mockCategoryService.getCategory(anyString()))
        ...
        verify(mockCategoryService, times(1)).getCategory(anyString());
    }
    ...
    public void shouldNotGetCategoryByIdIfCategoryDoesNotExistAgainstGivenId() throws Exception {
        when(mockCategoryService.getCategory("someCategory"))
        ...
        verify(mockCategoryService, times(1)).getCategory("someCategory");
    }
    ...
    public void shouldNotGetAnyCategoryOrderedByNameIfItDoesNotExists() throws Exception {
        ...
        final CategoriesListResponse categoriesListResponse = new ObjectMapper().readValue(response, CategoriesListResponse.class);
        assertEquals(categoriesListResponse.getCategories(), Collections.emptyList());
        verify(mockCategoryService, times(1)).getAllCategories();
    }
